        ...
        <div className=''>
           <div id='Home' className='grid md:flex divide-x-2'>
               <img className='h-[950px] md:h-[855px] md:-mt-20' src={myimg1} alt="" />
                <div className='text-2xl md:text-4xl font-semibold my-10 md:my-60 md:text-start p-4 color-white space-y-8'>
           ...
           <div className='flex mt-20 place-content-center'>
                <div className='grid grid-cols-2  md:grid-cols-3  text-2xl gap-6  md:gap-20 text-[#d12065] space-x-4 font-bold font-vidaloka'>
                    ...
                    <div className='grid md:ml-40 mt-10 w-40 bg-white shadow-2xl justify-center text-center p-4 '>
